...
class TextureBuffer {
    GLuint texture;
    public:
    TextureBuffer(const char *texturepath, GLenum format, GLenum wrappingS = GL_MIRRORED_REPEAT, GLenum wrappingT = GL_MIRRORED_REPEAT, GLenum min = GL_NEAREST_MIPMAP_LINEAR, GLenum mag = GL_LINEAR) {
